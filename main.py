...
mixer.music.load("tokyo_drift_beat.mp3")
mixer.music.play(-1)

FPS = 60
PATH = [(145, 109), (99, 66), (54, 104), (50, 355), (63, 417), (248, 593), (305, 606), (342, 559), (351, 440),
        (414, 403), (494, 440), (497, 572), (559, 611), (622,
                                                         560), (614, 352), (559, 305), (379, 304), (331, 260),
...
# kate
    ...
    def play_sound(self):
        sound = mixer.Sound("car_sound.mp3")
        sound.play()
...
class ComputerCar(AbstractCar):  
    ...
    def __init__(self, max_vel, rotation_vel, path=[]):  # all 3
        super().__init__(max_vel, rotation_vel)
        self.path = path
        self.current_point = 0
        self.vel = max_vel

    # for pointing out the point in path
    ...
    def draw(self, win):  
        super().draw(win)
        # self.draw_points(win) // for showing the point
